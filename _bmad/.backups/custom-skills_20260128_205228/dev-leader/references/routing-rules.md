...
|--------------------|------------|--------|
| Request involves React, Vue, CSS | Frontend Developer | React, Vue, CSS |
| Request involves FastAPI, Database | Backend Developer | FastAPI, Database |
| Request involves API Gateway, Integration | Middleware Developer | API Gateway, Integration |
